import { ProductCategoryEntity, ProductEntity, GalleryEntity, NewsEntity, CrmUserEntity } from '../database/entities';
...
export const config = {
  ...
  entities: [ProductCategoryEntity, ProductEntity, GalleryEntity, NewsEntity, CrmUserEntity],
