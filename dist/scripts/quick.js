...
async function createSpecifications() {
    const url = `${main_config_1.default.api_url}/api/product/specifications/create`;
    console.log('Creating product specifications...');
    try {
        for (let spec of specifications) {
            try {
                await axios_1.default.post(url, spec);
...
async function createCategories() {
    const url = `${main_config_1.default.api_url}/api/product/category/create`;
...
async function createProducts() {
    const url = `${main_config_1.default.api_url}/api/product/create`;
